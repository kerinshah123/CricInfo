 ...
 * Use the {@link TournamentPointtableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TournamentPointtableFragment extends Fragment {

    RecyclerView pointstable;
    ...
    public TournamentPointtableFragment() {
     ...
     * @return A new instance of fragment TournamentPointtableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TournamentPointtableFragment newInstance(String param1, String param2) {
        TournamentPointtableFragment fragment = new TournamentPointtableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tournament_pointtable, container, false);

        pointstable=view.findViewById(R.id.pointstable);
        ...
        pointstable.setLayoutManager(new LinearLayoutManager(getActivity()));
        pointstable.setAdapter(pointstableadapter);
